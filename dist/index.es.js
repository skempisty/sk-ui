...
function ir() {
  ...
  function w(h, f, R) {
    ...
    R !== void 0 && (_ = "" + R), f.key !== void 0 && (_ = "" + f.key), f.ref !== void 0 && (I = f.ref);
    for (v in f)
      y.call(f, v) && !A.hasOwnProperty(v) && (g[v] = f[v]);
    if (h && h.defaultProps)
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === A || De || e === F || e === R || e === v || ke || e === I || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === g || e.$$typeof === w || e.$$typeof === h || e.$$typeof === f || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
    ...
    var L = Object.prototype.hasOwnProperty, le = {}, fe = T.ReactDebugCurrentFrame;
    function N(e) {
      if (e) {
...
var sr = K.exports;
const lr = sr.jsx, cr = () => /* @__PURE__ */ lr("div", { children: "Hello World" }), dr = (P) => !!(P & 1);
export {
  cr as HelloWorld,
  dr as isOdd
};
